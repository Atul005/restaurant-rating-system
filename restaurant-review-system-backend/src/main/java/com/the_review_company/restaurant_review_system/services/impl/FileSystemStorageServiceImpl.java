...
import com.the_review_company.restaurant_review_system.services.StorageService;
...
public class FileSystemStorageServiceImpl implements StorageService {
    ...
    @Override
    public String store(MultipartFile multipartFile, String filename) {
        try {
            ...
            if(!destinationPath.getParent().equals(rootLocation.toAbsolutePath())){
                throw new StorageException("Cannot store outside specified territory");
            }
